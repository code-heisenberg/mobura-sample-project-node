...
class AuthRepository {
    registerUser =  async (body,emailverificationcode,emailCodeStatus) => {
        ...
        console.log(getOtp);
        console.log(emailverificationcode,getOtp.emailotp);
        if ( emailverificationcode == getOtp.emailotp) {
            ...
            let userdetails = UserModel.findByEmailOtpCodeAllData(emailverificationcode);
            ...
            return structureResponse({'userName':"",'With-OTP':""}, 1,'GOT vERiFiED => SUCCESSFULLY' );
