...
class AuthRepository {
    registerUser =  async (body,emailverificationcode,emailStatus) => {
        ...
        if(emailStatus=="sentForVerificationCode")
        {
          ...
          let otp_Time_ValueExtract = otp_Time["emailotp"];
          console.log("otp_Time=>"+JSON.stringify(otp_Time_ValueExtract));  
          let tempuserdata = body;
          let result = await UserModel.tempCreateUser(tempuserdata.user_id,tempuserdata.email,tempuserdata.userName,tempuserdata.dob,tempuserdata.address,tempuserdata.password,tempuserdata.mobile,emailverificationcode,otp_Time.emailotp,otp_Time.otpvalidity);
        }
