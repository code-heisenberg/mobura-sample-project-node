...
class AuthRepository {
    registerUser =  async (body,emailverificationcode,emailStatus) => {
        ...
        {
          const otpTime =[];
          otpTime =emailOtp.sendEmailOtp('prince.mobura@gmail.com');
          let tempuserdata = body;
          let result = await UserModel.tempCreateUser(tempuserdata.user_id,tempuserdata.email,tempuserdata.userName,tempuserdata.dob,tempuserdata.address,tempuserdata.password,tempuserdata.mobile,emailverificationcode);
        }
