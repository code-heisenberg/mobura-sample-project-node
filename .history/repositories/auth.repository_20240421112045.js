...
class AuthRepository {
    registerUser =  async (body,emailCodeStatus) => {
        ...
        if(emailCodeStatus=="sentForEmailOtpVerification")
        {
            ...
            let emailVerification = await emailVerifications.sendEmail('prince.mobura@gmail.com',emailVerificationCode);
        ...
        {
            let emailVeri = await UserModel.findByEmailVerificationCode(body);
