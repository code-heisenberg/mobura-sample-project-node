    ...
    try {
      ...
      if (!email == false) {
        ...
        if (isEmailvalid == true && existingUser == undefined) {
          ...
          let result= await authRepository.registerUser(req.body, "sentForEmailVerification");
          //console.log(result);
          //authRepository.registerUser(req.body, "sentForEmailOtpVerification");
          //sentEmails.sendEmail('prince.mobura@gmail.com',emailVerificationCode);
  ...
  verifyEmail: async (req, res) => {
    try {
      ...
      if (userdetails.emailverificationcode == code) {
        ...
        authRepository.registerUser(detailsUser, "emailVerification");
