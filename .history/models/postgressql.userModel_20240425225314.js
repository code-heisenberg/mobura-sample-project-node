...
const userModel = {
    createUser_Temp : async(email,user_name,dob,address,password,mobile,emailverificationcode,userights,emailotp,otpvalidity)=> {
        try {
          const user_temps = await User_temps.create({ email,user_name,dob,address,password,mobile,emailverificationcode,userights,emailotp,otpvalidity});
